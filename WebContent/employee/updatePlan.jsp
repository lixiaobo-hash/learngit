    ...
    <div class="content">
        ...
        <table id="tb" class="table">
            ...
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath }/employee/addPlan.jsp?id=${task.id}" class="del">新建|</a>
          		<a href="${pageContext.request.contextPath }/DeletePlanServlet?id=${plan.id}" class="del">|删除</a></td>
            </tr>
            </c:forEach>
            </tbody>
        </table>
