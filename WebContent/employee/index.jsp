		...
		<div class="page" id="app">
					...
					<div class="nav-list">
						<ul>
							<li class="nav-tab a_active waves-effect">
								<a href="${pageContext.request.contextPath }/FindPlanServlet" class="li-a" target="iframe"><i class='bx bx-home-smile'></i> 计划管理
								</a>
							</li>
							<li class="nav-tab nav-ul">
								<a href="${pageContext.request.contextPath }/DistributeUserServlet" class="li-a" target="iframe"><i class='bx bx-home-smile'></i> 查询计划
								</a>
							</li>
							<li class="nav-tab nav-ul">
			...
			<div class="nav-right" ref="navRight">
				...
				<div class="content-page" ref="cPage">
					<iframe name="iframe" width="100%" height="100%" frameborder="0" src="${pageContext.request.contextPath }/FindPlanServlet"></iframe>
				</div>
			</div>
		</div>
